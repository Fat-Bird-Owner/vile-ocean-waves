...
Blocks.beryllicStone.attributes.set(Attribute.get("beryllium"), 1);

Vars.content.block("gr-fissure-amalgam").stats.add(Stat.tiles, StatValues.blocks(Attribute.get("beryllium"), false, 1, true));
